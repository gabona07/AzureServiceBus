...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback {
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        setupLocations();
        showSectors();
        double latitude = getIntent().getDoubleExtra("latitude", 47.510134);
        double longitude = getIntent().getDoubleExtra("longitude", 19.051406);
        map.moveCamera(CameraUpdateFactory.newLatLngZoom(new LatLng(latitude, longitude), 16f));
    }
